...
public class Corridor {
    ...
    public void moveBottomRects(int x) {
    ...
    //create elements
    public void createTopLeftRects(int x) {
    ...
    public void createTopRightRects(int x) {
    ...
    public void createBottomRects(int x) {
    ...
    //DRAW
    //draw block
    public void drawCorridor(ShapeRenderer shapeRenderer, int x) {
    ...
    //draw block elements
    public void drawDown(ShapeRenderer shapeRenderer, int x) {
        //down corridor
    ...
    public void drawTopLeft(ShapeRenderer shapeRenderer, int x) {
        shapeRenderer.setColor(Color.BLACK);
    ...
    public void drawTopRight(ShapeRenderer shapeRenderer, int x){
        shapeRenderer.setColor(Color.BLACK);
